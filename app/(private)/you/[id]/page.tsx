    ...
    return (
        <main className="min-h-screen bg-gray-100 py-10 px-4 text-slate-800">
            <section className="mx-auto w-full max-w-2xl rounded-3xl border border-white/60 bg-white/90 p-6 shadow-[0_20px_50px_-12px_rgba(0,0,0,0.08)] backdrop-blur-sm sm:p-8">
                <div className="mb-6">
                    <h1 className="text-2xl font-extrabold tracking-tight text-slate-900 sm:text-3xl">Minha Conta</h1>
                    <p className="mt-1 text-sm text-slate-500">Atualize seus dados e gerencie seus endereços.</p>
                </div>

                <div className="space-y-4">
                    <div className="space-y-1.5">
                        <label className="ml-1 text-sm font-semibold text-slate-600">Nome</label>
                        <input
                            type="text"
                    ...
                    <div className="space-y-1.5">
                        <label className="ml-1 text-sm font-semibold text-slate-600">E-mail</label>
                        <input
                            type="email"
                    ...
                    <div className="space-y-1.5">
                        <label className="ml-1 text-sm font-semibold text-slate-600">Telefone</label>
                        <input
                            type="tel"
                            defaultValue=""
                            className="w-full rounded-2xl border border-slate-200/70 bg-white px-5 py-3.5 text-slate-800 shadow-sm outline-none transition-all duration-300 placeholder:text-slate-400 focus:border-blue-400 focus:bg-white focus:ring-4 focus:ring-blue-100"
                ...
                <div className="mt-8 space-y-4">
                    ...
                    <div className="rounded-2xl border border-dashed border-slate-300 bg-slate-50/70 p-4">
                        <p className="mb-3 text-sm font-semibold text-slate-700">Cadastrar novo endereço</p>
