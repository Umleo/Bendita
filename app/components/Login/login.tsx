    ...
    return (
        <>
            <div className="fixed top-4 left-4 z-50 flex flex-col gap-2">
                ...
                >
                    {logado ?
                        <div className={`p-5 flex flex-col w-64 h-full transition-opacity duration-300 ${isExpanded ? 'opacity-100' : 'opacity-0 pointer-events-none absolute'}`}>
                            ...
                            <div className="flex flex-col gap-4 flex-1 mt-2 mb-2">
                                ...
                                <Link href={`/you/${session?.user.id}`} className="flex-1 flex flex-col gap-2 min-h-5">
                                    ...
                                    <div className="rounded-2xl border border-gray-200 bg-white p-3 shadow-sm">
                                        <p className="text-sm font-semibold text-gray-800">Endereço 1</p>
                                        <p className="mt-1 text-xs text-gray-600">Rua das Palmeiras, 245</p>
                                    </div>
                                </Link>
                        ...
                        :
                        <div className={`absolute top-0 left-0 p-5 flex flex-col w-64 transition-opacity duration-300 ${isExpanded ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}>
                            ...
                            <div className="flex flex-col gap-2.5">
                                ...
                                <button className="w-full mt-2 bg-black text-white font-medium text-base py-2.5 rounded-full shadow-sm hover:bg-gray-800 transition-colors active:scale-[0.98] cursor-pointer"
